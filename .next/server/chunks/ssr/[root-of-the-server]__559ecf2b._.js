...
const createNewInterview = async ({ type, role, level, techstack, amount, cv })=>{
    const endpoint = `${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/vapi/generate-interview`;
...
const AuthPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const result = isSignUp ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registUser"])(username, email, password) : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginUser"])(email, password);
        if (!result.success) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__559ecf2b._.js.map