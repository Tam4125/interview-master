...
"[project]/backend/config/env.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dotenv$2f$lib$2f$main$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["config"])({
    path: `.env.${("TURBOPACK compile-time value", "development") || 'development'}.local`
});
const { PORT, SERVER_URL, NODE_ENV, DB_URI, JWT_SECRET, JWT_EXPIRES_IN } = process.env;
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$config$2f$env$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/config/env.js [app-ssr] (ecmascript)");
;
;
;
;
...
const getTechLogos = async (techArray)=>{
    const logoURLs = techArray.map((tech)=>{
        ...
        return {
            tech,
            url: `${__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["techIconBaseURL"]}/${normalized}/${normalized}-original.svg`
        };
    });
...
const signInAction = async ({ email, password })=>{
    ...
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$config$2f$env$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SERVER_URL"]}/api/v1/auth`, {
        method: "POST",
...
;
;
const DisplayTechIcon = async ({ techStack })=>{
...
const InterviewCard = ({ interview })=>{
    ...
    const formattedDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(feedback?.createdAt || interview.createdAt || Date.now()).format('MMM D, YYYY');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9de1e88f._.js.map